...
Public Class frmJobs
    ...
    Private Sub Puedemodificar()
        If txtJobId.TextLength > 0 And txtJobTitle.TextLength > 0 And txtMaxSalary.TextLength > 0 And txtMinSalary.TextLength > 0 Then
    ...
    Private Sub txtJobTitle_TextChanged(sender As Object, e As EventArgs) Handles txtJobTitle.TextChanged
        Puedemodificar()
        Puederegistrarse()
    End Sub

    Private Sub txtMinSalary_TextChanged(sender As Object, e As EventArgs) Handles txtMinSalary.TextChanged
        Puedemodificar()
        Puederegistrarse()
    End Sub

    Private Sub txtMaxSalary_TextChanged(sender As Object, e As EventArgs) Handles txtMaxSalary.TextChanged
        Puedemodificar()
        Puederegistrarse()
    End Sub
End Class