...
Public Class frmRegions
    ...
    Dim txtRegionId_TextChanged, txtRegionName_TextChanged As Integer
    ...
    Private Sub Puedemodificar()
        If txtRegionId.TextLength > 0 And txtRegionName.TextLength > 0 Then
    ...
    Private Sub txtRegionId_TextChanged_1(sender As Object, e As EventArgs) Handles txtRegionId.TextChanged
        Puedemodificar()
        Puederegistrarse()
        Puedeeliminar()
    ...
    Private Sub txtRegionName_TextChanged_1(sender As Object, e As EventArgs) Handles txtRegionName.TextChanged
        Puedemodificar()
        Puederegistrarse()
        Puedeeliminar()
